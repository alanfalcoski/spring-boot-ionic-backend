package com.alanfalcoski.cursomc.resources.exceptions;
...
import com.alanfalcoski.cursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> amazonService(AmazonServiceException e, HttpServletRequest request){		
		HttpStatus code = HttpStatus.valueOf(e.getErrorCode()); //Pegar o código HTTP que veio da exceção da amazon e transformar em objeto http.		
