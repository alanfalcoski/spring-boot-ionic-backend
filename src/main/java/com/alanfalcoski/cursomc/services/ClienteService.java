...
public class ClienteService {	
	...
	public void delete (Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não é possível apagar, há pedidos relacionados");
		}
	}
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		Cliente cli = new Cliente(null, objDto.getNome(), objDto.getEmail(), objDto.getDocumento(), TipoCliente.toEnum(objDto.getTipo()), pe.encode(objDto.getSenha()));
